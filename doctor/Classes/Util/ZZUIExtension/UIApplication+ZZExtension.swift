...
//        return Bundle.main.infoDictionary!["CFBundleIdentifier"] as! String
    ...
    var isChineseInputMode: Bool {
        return UIApplication.shared.textInputMode?.primaryLanguage == "zh-Hans"
    }
}
...
public extension UIApplication {
    ...
    func zz_call(phone: String) {
        open(URL(string: "tel://\(phone)")!, options: [:], completionHandler: nil)
    }
