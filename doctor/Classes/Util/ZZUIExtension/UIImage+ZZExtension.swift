...
public extension UIImage {
    ...
    func zz_asyncDrawImage(isAsyn: Bool = true, size: CGSize, isCircle: Bool = false, backColor: UIColor? = UIColor.white, finished: @escaping (_ image: UIImage) -> ()) {
        
        func _innerDrow() -> UIImage {
...
extension UIImage {
    ...
    func zz_resetToSize(_ maxSize: Int, maxWidth: CGFloat, maxHeight: CGFloat) -> Data {
        let maxWidth = maxWidth / UIScreen.main.scale
        let maxHeight = maxHeight / UIScreen.main.scale
...
//        let newImage = zz_newSize(targetSize)
        ...
        zz_asyncDrawImage(isAsyn: false, size: targetSize, isCircle: false, backColor: nil) { (image) in
            newImage = image
        }
...
//            let image = UIImage(data: finallImageData)!.zz_newSize(targetSize)
            ...
            var image: UIImage!
            UIImage(data: finallImageData)!.zz_asyncDrawImage(isAsyn: false, size: targetSize, isCircle: false, backColor: nil) { (img) in
                image = img
            }
