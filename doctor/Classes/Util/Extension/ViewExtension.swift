...
extension UIView {
    ...
    @discardableResult
    func addShadow(color: UIColor = UIColor.lightGray.withAlphaComponent(0.5), offset: CGSize = CGSize(width: 0, height: 2), opacity: Float = 1, cornerRadius: CGFloat = 5, shadowRadius: CGFloat = 5, topOffset: CGFloat = 0) -> UIView? {
