...
public extension String {
    ...
    var pinYin: String {
        ...
        return string.zz_ns.replacingOccurrences(of: " ", with: "")
    }
}
...
protocol EmptyString {
    ...
    var isNullOrEmpty: Bool { get }
}

extension Optional: EmptyString where Wrapped == String {
    func empty(_ defaultValue: String) -> String {
        switch self {
        case .none:
            return defaultValue
...
extension String: EmptyString {
    func empty(_ defaultValue: String) -> String { isEmpty ? defaultValue : self }
