//
//  EMREditFamillyController.swift
//  doctor
//
...
class EMREditFamillyController: BaseController {
    ...
    let viewModel = EMREditFamillyViewModel()
...
// MARK: - UI
extension EMREditFamillyController {
    override func setUI() {
...
extension EMREditFamillyController: UITableViewDataSource, UITableViewDelegate {
